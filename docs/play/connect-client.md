...
6. Run ArchipelagoLauncher.exe to bring up the normal AP launcher and look for a button that says "Manual Client". You may need to scroll down.
   ...
   * If you don't have it, download the apworld [here](https://github.com/ManualForArchipelago/Manual/releases/latest) and put it in the same `custom_worlds` folder as your apworld.

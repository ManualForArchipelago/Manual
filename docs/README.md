...
- [Game options](syntax/game-options.md)
- [Item options](syntax/item-options.md)
- [Location options](syntax/location-options.md)
- [Region options](syntax/region-options.md)
- [Categories](syntax/categories.md)
- [Category options](syntax/category-options.md)
